...
class ProjectContext:
    ...
    def server_instructions(self) -> str:
        sections = [
            ...
            "Relative paths, including apply_patch paths, use the persistent default cwd. When the ChatGPT Web Project name is known, call set_default_cwd with project_name before project work; it selects a same-named first-level workspace directory or falls back to the workspace root. A directory-only cd/chdir/Set-Location exec is also persisted automatically.",
